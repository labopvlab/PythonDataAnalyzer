# -*- coding: utf-8 -*-
"""
Created on Fri Oct  9 16:27:49 2015

@author: Roberto1
https://github.com/rdespoiu/tkinter-TicTacToe 

and adapted to fit here by JW
"""

import tkinter as tk
from tkinter import Tk, messagebox, Label, Entry, Button, Checkbutton, IntVar, Toplevel, OptionMenu, Frame, StringVar, Scrollbar, Listbox
from tkinter import *
import time
import random
...
class ticTacToe(Toplevel):
    def __init__(self, *args, **kwargs):
        Toplevel.__init__(self, *args, **kwargs)
        Toplevel.wm_title(self, 'Tic Tac Toe')
        Toplevel.config(self,background="white")
        self.wm_geometry("455x530")
        ...
        self.grid1 = Button(self, state = DISABLED, command = self.grid1Pressed)
        ...
        self.grid2 = Button(self, state = DISABLED, command = self.grid2Pressed)
        ...
        self.grid3 = Button(self, state = DISABLED, command = self.grid3Pressed)
        ...
        self.grid4 = Button(self, state = DISABLED, command = self.grid4Pressed)
        ...
        self.grid5 = Button(self, state = DISABLED, command = self.grid5Pressed)
        ...
        self.grid6 = Button(self, state = DISABLED, command = self.grid6Pressed)
        ...
        self.grid7 = Button(self, state = DISABLED, command = self.grid7Pressed)
        ...
        self.grid8 = Button(self, state = DISABLED, command = self.grid8Pressed)
        ...
        self.grid9 = Button(self, state = DISABLED, command = self.grid9Pressed)        
        ...
        self.newStartGame = Button(self, text = self.newStartGameText.get())
        ...
        self.whoseTurn = Label(self, text = self.whoseTurnText.get())
        self.whoseTurn.grid(row = 4, column = 0)
        
        #Score Label
        self.score = Label(self, text = 'Score: {}'.format(self.scoreText))
